...
var es5 = __webpack_require__(10);
  ...
  module.exports = XMLNode = (function() {
    function XMLNode(parent) {
      ...
      if (!XMLElement) {
        ...
        XMLRaw = __webpack_require__(28);
        XMLText = __webpack_require__(29);
        XMLProcessingInstruction = __webpack_require__(30);
      }
    }
...
(function() {
  ...
  XMLDTDAttList = __webpack_require__(24);

  XMLDTDEntity = __webpack_require__(25);

  XMLDTDElement = __webpack_require__(26);

  XMLDTDNotation = __webpack_require__(27);
...
(function() {
  ...
  XMLWriterBase = __webpack_require__(57);
...
var util = __webpack_require__(0);
var getKeys = __webpack_require__(10).keys;
...
var _xml2js = __webpack_require__(108);

var _xml2js2 = _interopRequireDefault(_xml2js);

var _nodeEval = __webpack_require__(121);

var _nodeEval2 = _interopRequireDefault(_nodeEval);

var _fs = __webpack_require__(125);

var _lodash = __webpack_require__(126);

var _bluebird = __webpack_require__(127);
...
var _sqlstring = __webpack_require__(159);
...
var Mybatis3 = function () {
  function Mybatis3() {
    (0, _classCallCheck3.default)(this, Mybatis3);
  ...
  (0, _createClass3.default)(Mybatis3, [{
    key: 'setConnection',
    value: function setConnection(pool) {
      this.pool = pool;
      this.pool.getConnectionAsync = _bluebird2.default.promisify(this.pool.getConnection);
    }
  }, {
    key: 'getConnection',
    value: function getConnection() {
      if ((0, _lodash.isFunction)(this.pool)) {
        return this.pool();
      } else {
        return this.pool;
      }
    ...
    value: function fnModel(name, conn) {
      ...
      var self = this;
      (0, _lodash.forEach)(table, function (fn, key) {
        if (key === 'lastQuery') {
          ...
          ctx[key] = (0, _lodash.partialRight)(fn, conn);
        }
      });
      return ctx;
    }
    ...
    key: 'transaction',
    value: function () {
      var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(execQuery) {
        var connection, rst;
        return _regenerator2.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                connection = void 0, rst = void 0;
                _context.prev = 1;
                _context.next = 4;
              ...
              case 4:
                ...
                connection.table = (0, _lodash.partialRight)(this.fnModel, connection).bind(this);
                _context.next = 8;
    ...
    value: function loadQuery(tableName, path, xmlFilenames) {
      ...
      (0, _lodash.forEach)(xmlFilenames, function (filename, idx) {
        _this.sqlData = idx === 0 ? {} : _this.sqlData;
        var ext = (0, _path.extname)(filename);
        var dir = ext ? (0, _path.join)(path, filename) : (0, _path.join)(path, filename + '.xml');
        var xml = (0, _fs.readFileSync)(dir, 'utf-8');
        // log.debug('xmls', xml)
        parser.parseString(xml, function (err, data) {
          ...
          (0, _lodash.chain)(commands).map(function (cmd) {
            return jsonData[cmd] || [];
    ...
    value: function getQuery(tableName) {
      ...
      (0, _lodash.forEach)(sqlData, function (sql, key) {
        rst[key] = function () {
          var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(params, conn) {
            var qry, _conn;
    ...
    key: 'process',
    value: function () {
      var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee5(xml, params) {
        var _this3 = this;
        ...
        return _regenerator2.default.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                return _context5.abrupt('return', _bluebird2.default.resolve(xml).then(function () {
                  var _ref4 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(xml) {
                      ...
                      while (1) {
                        switch (_context4.prev = _context4.next) {
                          case 0:
                            ...
                            xml._ = '';
                            _context4.next = 3;
                            return _bluebird2.default.each(xml['$$'], function () {
                                ...
                                return _regenerator2.default.wrap(function _callee3$(_context3) {
                                  while (1) {
                                    switch (_context3.prev = _context3.next) {
                                      ...
                                      case 3:
                                        proc = 'process' + _this3.capitalizeFirstLetter(item['#name']);
                                        _context3.next = 6;
    ...
    key: 'processInclude',
    value: function () {
      var _ref6 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee6(item, params) {
        var id, t;
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                id = item.$.refid;
                t = (0, _lodash.find)(this.references, { $: { id: id } });
    ...
    key: 'processDeep',
    value: function () {
      var _ref7 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee7(xml, params) {
        var keys;
    ...
    key: 'processIf',
    value: function () {
      var _ref8 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee8(item, params) {
        var test;
    ...
    key: 'processChoose',
    value: function () {
      var _ref9 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee10(item, params) {
        var _this4 = this;
        ...
        return _regenerator2.default.wrap(function _callee10$(_context10) {
          while (1) {
            switch (_context10.prev = _context10.next) {
              case 0:
                _context10.next = 2;
                return _bluebird2.default.each(item['$$'], function () {
                  var _ref10 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee9(_case) {
                    var testStr, test;
                      ...
                      while (1) {
                        switch (_context9.prev = _context9.next) {
                          case 0:
                            ...
                            testStr = (0, _lodash.get)(_case, '$.test');
                          ...
                          case 10:
                            ...
                            throw new _bluebird2.default.CancellationError('matched');
    ...
    key: 'processTrim',
    value: function () {
      var _ref11 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee12(item, params) {
        var _this5 = this;
          ...
          while (1) {
            switch (_context12.prev = _context12.next) {
              case 0:
                _context12.next = 2;
                return _bluebird2.default.each(item['$$'], function () {
                  var _ref12 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee11(_case) {
                    var testStr, test;
    ...
    key: 'processWhere',
    value: function () {
      var _ref13 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee14(item, params) {
        var _this6 = this;
          ...
          while (1) {
            switch (_context14.prev = _context14.next) {
              case 0:
                _context14.next = 2;
                return _bluebird2.default.each(item['$$'], function () {
                  var _ref14 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee13(_case) {
                    var testStr, test;
    ...
    key: 'processSet',
    value: function () {
      var _ref15 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee16(item, params) {
        var _this7 = this;
          ...
          while (1) {
            switch (_context16.prev = _context16.next) {
              case 0:
                _context16.next = 2;
                return _bluebird2.default.each(item['$$'], function () {
                  var _ref16 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee15(_case) {
                    var testStr, test;
    ...
    key: 'processForeach',
    value: function () {
      var _ref17 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee18(item, params) {
        var _this8 = this;
        ...
        return _regenerator2.default.wrap(function _callee18$(_context18) {
          while (1) {
            switch (_context18.prev = _context18.next) {
              ...
              case 2:
                collection = (0, _lodash.get)(params, item.$.collection) || [];
                processedArr = [];
                // log.debug(collection, 'collection')

                _context18.next = 6;
                return _bluebird2.default.each(collection, function () {
                  var _ref18 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee17(col, idx) {
                    ...
                    return _regenerator2.default.wrap(function _callee17$(_context17) {
                      while (1) {
                        switch (_context17.prev = _context17.next) {
                          case 0:
                            _context17.next = 2;
                            return _this8.processVariable(item._, (_this8$processVariabl = {}, (0, _defineProperty3.default)(_this8$processVariabl, item.$.item, col), (0, _defineProperty3.default)(_this8$processVariabl, item.$.index, idx), _this8$processVariabl));
    ...
    key: 'processBind',
    value: function () {
      var _ref19 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee19(item, params) {
        var s;
          ...
          while (1) {
            switch (_context19.prev = _context19.next) {
              ...
              case 2:
                ...
                params[item.$.name] = (0, _nodeEval2.default)(s);
    ...
    key: 'processVariable',
    value: function () {
      var _ref20 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee20(qry, params) {
        var rst, escape, reg;
          ...
          while (1) {
            switch (_context20.prev = _context20.next) {
              case 0:
                ...
                escape = _sqlstring2.default.escape;
                reg = _config2.default.sql.queryFormat ? new RegExp(_config2.default.sql.queryFormat, 'g') : /#{([\w_.]+)}/g;

                rst = qry.replace(/\)/g, ' )').replace(/\( \)/g, '()').replace(reg, function (txt, key) {
                  key = key.replace(/\(\)/g, '');
                  var val = (0, _lodash.get)(params, key);
                  if ((0, _lodash.isFunction)(val)) {
                    val = val();
                  } else if ((0, _lodash.isObject)(val) || (0, _lodash.isArray)(val)) {
                    val = true;
                  }
                  return escape(val, _config2.default.sql.stringifyObjects, _config2.default.sql.timezone);
                });
    ...
    key: 'changeAndOr',
    value: function () {
      var _ref21 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee21(str) {
    ...
    value: function processFix(item, xml) {
      if (xml.$.prefixOverrides) {
        var reg = new RegExp('^' + xml.$.prefixOverrides, 'gi');
        item._ = item._.replace(reg, '');
      }
      // log.debug('fix', item._)
      if (xml.$.suffixOverrides) {
        var _reg = new RegExp(xml.$.suffixOverrides + '$', 'gi');
        item._ = item._.replace(_reg, '');
      }
      // log.debug('fix', '|' + item._ + '|')
      if (!(0, _lodash.isEmpty)(item._)) {
    ...
    value: function merge_(xml, choose) {
      var processedArr = [];
      (0, _lodash.forEach)(xml['$$'], function (item) {
        if (item._) {
...
(function() {
  ...
  processors = __webpack_require__(58);
...
(function() {
  ...
  XMLDocument = __webpack_require__(111);

  XMLDocumentCB = __webpack_require__(112);

  XMLStringWriter = __webpack_require__(39);

  XMLStreamWriter = __webpack_require__(113);
...
(function() {
  ...
  XMLStringifier = __webpack_require__(56);
...
(function() {
  ...
  sax = __webpack_require__(115);

  events = __webpack_require__(118);

  bom = __webpack_require__(119);
...
;(function (sax) { // wrapper for non-node envs
  ...
  var Stream
  try {
    Stream = __webpack_require__(116).Stream
  } catch (ex) {
    Stream = function () {}
  }
  ...
  SAXStream.prototype.write = function (data) {
    if (typeof Buffer === 'function' &&
      ...
      if (!this._decoder) {
        var SD = __webpack_require__(117).StringDecoder
...
const vm = __webpack_require__(122);
const path = __webpack_require__(60);
const Module = __webpack_require__(123);

const isAbsolutePath = __webpack_require__(124);
...
var bluebird = __webpack_require__(128)();
...
var es5 = __webpack_require__(10);
var Async = __webpack_require__(129);
var async = new Async();
...
var APPLY = {};
var NEXT_FILTER = {};
var tryConvertToPromise = __webpack_require__(132)(Promise, INTERNAL);
var PromiseArray =
    __webpack_require__(133)(Promise, INTERNAL,
                               tryConvertToPromise, apiRejection, Proxyable);
var Context = __webpack_require__(134)(Promise);
 /*jshint unused:false*/
var createContext = Context.create;
var debug = __webpack_require__(135)(Promise, Context);
var CapturedTrace = debug.CapturedTrace;
var PassThroughHandlerContext =
    __webpack_require__(136)(Promise, tryConvertToPromise, NEXT_FILTER);
...
var schedule = __webpack_require__(130);
